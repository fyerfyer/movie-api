...
// out: the output destination the log entries will be written to
// mutex: coordinating the writes
type Logger struct {
	out      io.Writer
	minLevel Level
	mu       sync.Mutex
...
func formattedStackString() string {
...
func (l *Logger) print(level Level, message string, properties map[string]string) (int, error) {
	...
	if level >= LevelError {
		aux.Trace = formattedStackString()
	}
